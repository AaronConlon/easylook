...
import pageAboutData from '@/apis/__api-mocks__/api/page/page-about-mock.json';
import pageHomeData from '@/apis/__api-mocks__/api/page/page-home-mock.json';
import pageProductData from '@/apis/__api-mocks__/api/page/page-product-mock.json';
import pageShareData from '@/apis/__api-mocks__/api/page/page-share-mock.json';
