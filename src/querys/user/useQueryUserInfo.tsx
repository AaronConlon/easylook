...
import type {
  IAPI_V1_USER_INFO_GET_ITEM,
  IAPI_V1_USER_INFO_GET_REQ,
} from '@/apis/user-api';
import { API_URL_GET__V1_USER_INFO_GET } from '@/apis/user-api';

type IQueryRes = { data?: IAPI_V1_USER_INFO_GET_ITEM };
type IQueryReq = IAPI_V1_USER_INFO_GET_REQ;

//
// 🟩 GET API (ITEM) - 1.获取用户信息
const API_URL = API_URL_GET__V1_USER_INFO_GET;
