import type {
  VideoCategory,
  VideoTask,
} from './_comps/ProductVideosSection/ProductVideosSection';
...
export const product1VideoCategories: VideoCategory[] = [
  {
    ...
    taskVoList: [
      createTask({
        ...
        title: 'Hart字母表基础训练',
        brief:
          'Hart字母表-基础调节幅度训练，是一项专门改善双眼调节功能的视觉训练方法，侧重于建立和恢复调节幅度。本训练旨在提高双眼清晰视物的范围，提高双眼在特定距离目标间的快速、准确切换焦点的能力，缓解调节滞后带来的视疲劳。',
        src: 'https://cdn-mini.easylook.com.cn/train/hart_alphabet_chart_basic.mp4',
        poster: 'https://cdn-mini.easylook.com.cn/train/hart_alphabet_chart_basic.jpg',
      }),
      createTask({
      ...
      createTask({
        ...
        title: 'Hart字母表高级训练',
        brief:
          'Hart字母表-进阶调节幅度训练,是一项专门强化双眼调节功能的视觉训练方法，侧重于突破双眼清晰视物的范围，进一步提升双眼调节功能。本训练旨在提高调节精准度与持久力，强化动态调节能力，缓解调节滞后带来的视疲劳。',
  ...
  },
  {
    ...
    taskVoList: [
      ...
      createTask({
        ...
        poster: 'https://cdn-mini.easylook.com.cn/train/hart_saccade_parallel_2.jpg',
      }),
      createTask({
        ...
        poster: 'https://cdn-mini.easylook.com.cn/train/hart_saccade_random_2.jpg',
      }),
    ],
  },
];
