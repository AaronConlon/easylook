...
// @ts-ignore
import { eslintConfigUniImportOrderPathGroups } from './eslint-config-uni-import-order-path-groups';

const OFF = 'off';
const WARN = 'warn';
const ERROR = 'error';

export const eslintConfigUniRules: SharedConfig.RulesRecord = {
  // common
  'no-console': OFF,
  ...
  'import/order': [
    WARN,
    {
      ...
      pathGroups: eslintConfigUniImportOrderPathGroups,
