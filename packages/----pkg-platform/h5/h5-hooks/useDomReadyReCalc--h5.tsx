...
export const useDomReadyReCalc = () => {
  ...
  const onResizeChangeReCalc = () => {
    ...
    docElm.style.setProperty('--app-width', `${window.innerWidth}px`);
  ...
  const onInitChangeReCalc = () => {
    const docElm = document.documentElement;
    docElm.style.setProperty('--app-init-height', `${window.innerHeight}px`);
    docElm.style.setProperty('--app-init-width', `${window.innerWidth}px`);
