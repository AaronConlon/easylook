...
// SingleIcon-01--tsx
let ICheckboxBlankCircleFill: FunctionComponent<Props> = ({ size, color, ...rest }) => {
...
ICheckboxBlankCircleFill = React.memo ? React.memo(ICheckboxBlankCircleFill) : ICheckboxBlankCircleFill;
