...
// SingleIcon-01--tsx
let IUserSmileLine: FunctionComponent<Props> = ({ size, color, ...rest }) => {
...
IUserSmileLine = React.memo ? React.memo(IUserSmileLine) : IUserSmileLine;

export default IUserSmileLine;
